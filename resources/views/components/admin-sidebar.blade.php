...
<div class="col-md-3 col-lg-2 p-0 d-flex flex-column" id="sidebar" style="height: 100%;">
    ...
    <ul class="nav flex-column p-3 flex-grow-1 overflow-auto" id="sidebarMenu">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.usuarios') }}">Gestión de Usuarios</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.locales') }}">Gestión de Locales</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('promociones') }}">Gestión de Promociones</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.novedades') }}">Gestión de Novedades</a>
        </li>
